package com.pki.filter;


import com.pki.controller.BaseController;
...
public class LoginFilter implements Filter {
    ...
    static {
        nofilterUrl.put("/users/registerGo.do", "/users/registerGo.do");
        nofilterUrl.put("/users/register.do", "/users/register.do");
        nofilterUrl.put("/users/login.do", "/users/login.do");
        nofilterUrl.put("/users/forgetUI.do", "/users/forgetUI.do");
        nofilterUrl.put("/users/forget.do", "/users/forget.do");
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        boolean isfilter = nofilterUrl.get(servletPath) != null;
        boolean flag = false;
